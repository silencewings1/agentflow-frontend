...
/* ==================== 模拟运行数据 ==========================
   每个模板给出节点最终态与少量消息，供 DAG 节点详情视图使用。
   ===================================================================== */
...
export const wfRuns: Record<string, WfRun> = {
  ...
  "wf-bugfix": runFeature,
  "wf-unit": runFeature,
  "wf-legacy": runFeature,
  "wf-cve": runFeature,
  "wf-review": runFeature,
  "wf-custom": runFeature,
};
